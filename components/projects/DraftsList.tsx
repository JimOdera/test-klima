        ...
        <>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2">
                                    <Link href="/projects/form" className="border border-gray-300 text-gray-700 text-xs font-semibold px-4 py-1.5 rounded-full hover:bg-gray-50 transition-colors whitespace-nowrap">
                                        Continue
                                    </Link>
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100 text-xs text-gray-500">
                <div className="flex items-center gap-3">
                    <span>{drafts.length} of {drafts.length}</span>
